<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SqlParameterDirectionExample.aspx.cs" Inherits="ADONETDemo_SqlParameterDirectionExample" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label3" runat="server" Text="Suma"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label4" runat="server" Text="Resta"></asp:Label>
                </td>
                <td>
